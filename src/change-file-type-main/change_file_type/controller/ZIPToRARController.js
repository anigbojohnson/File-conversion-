...
const ZIPToRAR =async(req, res)=>{ 
   ...
   let zipFilter = (req, file , cb)=>{
    if(file.mimetype === "application/zip" || file.mimetype === 'application/x-zip'|| file.mimetype === "application/x-zip-compressed" || file.mimetype === 'application/octet-stream'){
        ...
        if(req.files==undefined){
            ...
            res.status(201).json(
                ...
                req.files.forEach(file=>{
                    ...
                    pythonZipToRarConvert = new PythonShell(path.join("pythonProject","zipToTar.py"),{
                        mode: "text",
                        pythonPath:'python',
